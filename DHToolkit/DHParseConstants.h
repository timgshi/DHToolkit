...
#ifndef DHToolkit_DHParseConstants_h
#define DHToolkit_DHParseConstants_h
...
#define kDHDataGroupsKey @"groupsArray"

#define PFClass_DHPhoto @"DHPhoto"
#define PFClass_DHGroup @"DHGroup"
